...
const Footer = () => {
  ...
  <div className="space-y-4 text-gray-600">
    <div className="flex items-center space-x-3">
      <Mail className="w-5 h-5 text-[#223794] hover:text-[#223794] hover:blur-[1px] transition-all duration-200" />
      <span className="hover:text-[#223794] hover:blur-[0.5px] transition-all">info@impviser.com</span>
    </div>
    <div className="flex items-center space-x-3">
      <Phone className="w-5 h-5 text-[#223794] hover:text-[#223794] hover:blur-[1px] transition-all duration-200" />
      <span className="hover:text-[#223794] hover:blur-[0.5px] transition-all">+91 9345861817</span>
    </div>
    <div className="flex items-start space-x-3">
      <MapPin className="w-6 h-6 text-[#223794] hover:text-[#223794] hover:blur-[1px] transition-all duration-200 mt-1" />
      <span className="hover:text-[#223794] hover:blur-[0.5px] transition-all">
